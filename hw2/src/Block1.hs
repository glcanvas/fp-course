...
--               Branch ( Leaf (.) <*> f1 ) (Leaf (.) <*> f2 ) <*> (Branch g1 g2) <*> (Leaf x) ==
--                Branch ((Leaf (.) <*> f1) <*> g1) ((Leaf (.) <*> f2) <*> g2) <*> Leaf x ==
--                  Branch ((Leaf (.) <*> f1) <*> g1 <*> Leaf x) ((Leaf (.) <*> f2) <*> g2 <*> Leaf x)
--
...
--        morning
--         c) (Leaf (.)) <*> (Branch f1 f2) <*> (Branch g1 g2) <*> (Branch x1 x2) ==
--              Branch (Leaf (.) <*> f1) (Leaf (.) <*> f2) <*> (Branch g1 g2) <*> (Branch x1 x2) ==
--                Branch ( (Leaf (.) <*> f1) <*> g1) ( (Leaf (.) <*> f2) <*> g2) ==
--                  Branch ( ( (Leaf (.) <*> f1) <*> g1) <*> x1) ( ( (Leaf (.) <*> f2) <*> g2) <*> x2)

--            (Branch f1 f2) <*> ((Branch g1 g2) <*> (Branch x1 x2)) ==
--              (Branch (f1 f2) <*> (Branch (g1 <*> x1) (g2 <*> x2)) ==
--                (Branch (f1 <*> (g1 <*> x1)) (f2 <*> (g2 <*> x2)))
